...
return array(
	...
	'AllowDuplicateEmails'		=> false,					// Whether multiple accounts may use the same verified email address.
	'RequireEmailConfirm'		=> true,					// Require email confirmation before game or control-panel login.
	'RequireChangeConfirm'		=> true,					// Verify a new email address before storing it.
	'EmailConfirmExpire'		=> 24,					// Registration confirmation lifetime in hours.
	'RecoveryTokenExpire'		=> 30,					// Password and PIN recovery lifetime in minutes.
	...
	'AllPlayersVIP'				=> false,					// Treat every player account as VIP without an expiration timestamp.
	...
	'MailerSMTPTimeout'			=> 10,						// SMTP connection timeout in seconds.
...
// Discord Webhooks
	...
	'MenuItems'		=> array(
		...
		'AccountLabel'		=> array(
			...
			'ResetPassTitle'		=> array('module' => 'account', 'action' => 'resetpass'),
			'ResetPinTitle'		=> array('module' => 'account', 'action' => 'requestpin'),
			'ResendTitle'			=> array('module' => 'account', 'action' => 'resend'),
